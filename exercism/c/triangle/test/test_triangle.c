...
static void test_equilateral_is_true_if_all_sides_are_equal(void)
{
   triangle_t sides = { 2, 2, 2 };
   TEST_ASSERT_TRUE(is_equilateral(sides));
}

static void test_equilateral_is_false_if_any_side_is_unequal(void)
{
   triangle_t sides = { 2, 3, 2 };
   TEST_ASSERT_FALSE(is_equilateral(sides));
}

static void test_equilateral_is_false_if_all_sides_zero(void)
{
   triangle_t sides = { 0, 0, 0 };
   TEST_ASSERT_FALSE(is_equilateral(sides));
}

static void test_equilateral_sides_may_be_floats(void)
{
   triangle_t sides = { 0.5, 0.5, 0.5 };
   TEST_ASSERT_TRUE(is_equilateral(sides));
}

static void test_isosceles_is_true_if_last_two_sides_are_equal(void)
{
   triangle_t sides = { 3, 4, 4 };
   TEST_ASSERT_TRUE(is_isosceles(sides));
}

static void test_isosceles_is_true_if_first_two_sides_are_equal(void)
{
   triangle_t sides = { 4, 4, 3 };
   TEST_ASSERT_TRUE(is_isosceles(sides));
}

static void test_isosceles_is_true_if_first_and_last_sides_are_equal(void)
{
   triangle_t sides = { 4, 3, 4 };
   TEST_ASSERT_TRUE(is_isosceles(sides));
}

static void test_equilateral_triangles_are_also_isosceles(void)
{
   triangle_t sides = { 4, 4, 4 };
   TEST_ASSERT_TRUE(is_isosceles(sides));
}

static void test_isosceles_is_false_if_no_sides_are_equal(void)
{
...
static void test_isosceles_sides_may_be_floats(void)
{
   triangle_t sides = { 0.5, 0.4, 0.5 };
   TEST_ASSERT_TRUE(is_isosceles(sides));
}

static void test_scalene_is_true_if_no_sides_are_equal(void)
{
   triangle_t sides = { 5, 4, 6 };
   TEST_ASSERT_TRUE(is_scalene(sides));
}

static void test_scalene_is_false_if_all_sides_are_equal(void)
{
   triangle_t sides = { 4, 4, 4 };
   TEST_ASSERT_FALSE(is_scalene(sides));
}

static void test_scalene_is_false_if_two_sides_are_equal(void)
{
   triangle_t sides = { 4, 4, 3 };
   TEST_ASSERT_FALSE(is_scalene(sides));
}

static void test_scalene_is_false_if_no_sides_equal_and_violate_inequality(void)
{
   triangle_t sides = { 7, 3, 2 };
   TEST_ASSERT_FALSE(is_scalene(sides));
}

static void test_scalene_sides_may_be_floats(void)
{
